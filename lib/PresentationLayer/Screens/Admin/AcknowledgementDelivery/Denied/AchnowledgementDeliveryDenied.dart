...
class AcknowledgmentDeliveryDenied extends StatefulWidget{
  const AcknowledgmentDeliveryDenied({super.key});

  @override
  State<StatefulWidget> createState() => _AcknowledgmentDeliveryDenied();

}

class _AcknowledgmentDeliveryDenied extends State<AcknowledgmentDeliveryDenied>{

  DeliveryBloc deliveryBloc = DeliveryBloc();

  @override
  void initState() {
    deliveryBloc.add(const GetListEquipmentDeliveryAdminDenied());
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: const Text("List Denied Delivery",
          ...
          return GestureDetector(
            onTap: () {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const AcknowledgementDetailsDenied(),
