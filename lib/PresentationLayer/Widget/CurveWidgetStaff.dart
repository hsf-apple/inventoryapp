...
class CurveWidgetStaff extends StatelessWidget {

  final Widget child;
  final double curveDistance;
  final double curveHeight;

  const CurveWidgetStaff({Key? key, required this.child,  this.curveDistance = 70,  this.curveHeight = 70}) : super(key: key);
